package ru.bulk.command;

import lombok.Data;
import lombok.val;
import ru.bulk.command.annotation.AnnotationCommandResolver;
import ru.bulk.command.context.CommandContext;
import ru.bulk.command.context.SimpleCommandContext;
import ru.bulk.command.exception.CommandException;
import ru.bulk.command.exception.CommandExecuteException;
import ru.bulk.command.exception.CommandParseException;
import ru.bulk.command.manager.CommandManager;
import ru.bulk.command.parameter.CommandParameter;
import ru.bulk.command.parameter.resolver.ParameterResolver;
import ru.bulk.command.registry.CommandRegistry;
import ru.bulk.command.registry.ParentCommandRegistry;
import ru.bulk.command.require.CommandRequire;
